...
The `Python` section of the project settings file declares the Python version for the project. For example, this declares Python version **3.13.6**:
...
.. note::
   ...
   When you create a new Celbridge project an up-to-date version of Python will be declared here, in the project settings file created with the project.
